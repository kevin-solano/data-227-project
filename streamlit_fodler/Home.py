...
st.title("DATA 22700 Final Project: Following deportation trends in the U.S. for the last ten years (2015 - 2025)")

st.write(Image.open('images/cdac_uchicago_logo.jpeg'))

st.write("This project is intended to highlight trends from given deportation data across\
        two sources: the U.S. Immigration and Customs Enforcement statistics site and the\
        Deportation Data site on historical deportation data. Charts are made using Altair,\
...
st.write(
    ...
    "- **Data Dashboard**: Interactive Database exploration.\n"
